    ...
    return(
        <>
            <div className="flex gap-2">
              <input className="bg-gray-200 rounded-full py-1 px-2 w-full border my-1" type="text" placeholder="Add using a link...lpg" value={photoLink} onChange={e => { setPhotoLink(e.target.value) }} />
            ...
            <div className="grid grid-cols-3 gap-2 md:grid-cols-4 lg:grid-cols-6 mt-4">
              {addedPhotoes.length > 0 && addedPhotoes.map(link => (
                <div className="h-32 flex relative" key={link}>
                  <img className="w-full rounded-2xl object-cover" src={"http://localhost:4000/upload/" + link} />
              ...
              <label className="h-32 flex justify-around gap-2 border-2 bg-transperent rounded-2xl p-8 text-2xl text-gray-600 items-center cursor-pointer" >
                <input onChange={upload} multiple type="file" className="hidden "></input>
